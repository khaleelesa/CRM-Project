...
const data = require("../data-files/data.json");
const countries = require("../data-files/countries.js");
...
const addClient = async (client) => {
  let emailType =
    client.emailType !== null
      ? await findByID("email_type", "email_type", client.emailType)
      : null;
